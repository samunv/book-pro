window.addEventListener("DOMContentLoaded", function () {
	...
	let contenedorCitas = document.getElementById("citas-container");
	...
	function generarFilaCita(cita, horaHorario) {
		return `
					<tr>
							...
							<td class='columna-cita'>
									<div class='caja-cita' draggable='true' id='elemento-arrastrable${cita.id}'>
							...
							<td class='td-iconos'>
									...
									<div class='icono-texto eliminar' id='papelera-${cita.idCita}'>Cancelar</div>
							</td>
					</tr>`;
	}
