...
<head>
	...
	<!--Librería Sortable para poder arrastrar elementos HTML y soltarlos en otros-->
...
<body>
	...
	<div id="ventana-eliminar" class="ventanas">
		...
		<p>
			<strong>Cuidado, </strong> No podrás deshacer esta acción. La anulación de tu cita será notificada a <span id="span-profesional"></span>. Si has pagado, recibirás un reembolso en un plazo de 5-10 días.
		</p>
